...
let heartRate2 = 70
let heartRate3 = 75
let addedHR = hearRate1 + heartRate2 + heartRate3
print(addedHR)
...
print(averageHRD)
print("Technically they are the same but using double for the averagehrd made it more clear and more accurate rather than just rounding.")
