...
print("This is different from integer division because a double uses a decimal value instead of a whole number.")
...
print(even)
print(odd)
print("If the remainder comes out to be an odd integer.")
