...
print("foo is in the local scope with int he brackets of the code. Whereas the print statement at the end is outside where foo is located.")
...
print("Because it references the global scope from line 15, even though its outside the brackets it still within the global scope because of line 15.")
...
greeting(greeting: "Live long and prosper", name: "Sara")
...
Car(make: "Chevy", model: "Camaro", year: 2020)
/*:
