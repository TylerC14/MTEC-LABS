...
let fullName = firstName + lastName // "Tyler Christensen"
print(fullName)
...
let newBest = 15125
let name = "Tyler Christensen"
let congratulations = "Congratulations, \(name)! You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!" // the label displays "Congratulations Tyler Christensen! You beat your previous daily high score of 14392 steps by walking 15125 steps yesterday!"
