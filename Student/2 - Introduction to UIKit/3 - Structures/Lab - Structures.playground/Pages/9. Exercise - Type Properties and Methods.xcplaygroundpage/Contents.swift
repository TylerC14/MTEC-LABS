...
struct User {
    ...
    static var currentUser = User(userName:"Tyler", email: "tyler.chris@live.com", age: 24)
...
let user = User(userName: "", email: "", age: 24)
user.userName

print(User.currentUser)

let anotherUser = User(userName: "Tyler", email: "tyler.chris@live.com", age: 24)
