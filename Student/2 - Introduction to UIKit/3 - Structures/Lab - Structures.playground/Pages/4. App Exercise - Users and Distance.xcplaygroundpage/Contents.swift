 ...
 */
struct User {
    var username: String = "Tyler"
    var age: Int = 24
    var height: Double = 6
    var weight: Double = 200
    var activityLevel: Int = 8
    
}

//:  Create a variable instance of `User` and call it your name. Use the memberwise initializer to pass in information about yourself. Then print out a description of your `User` instance using the instance's properties.
var Tyler = User(username: "Tyler", age: 24, height: 5.8, weight: 200, activityLevel: 8)
print(Tyler)
...
print(Distance.init(meters: 1600))
//:  Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
var mile = Distance(meters: 1600)
print(Distance.init(meters: 1600))

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var kilometers = Distance(meters: 50)
print(Distance.init(meters: 50))
/*:
