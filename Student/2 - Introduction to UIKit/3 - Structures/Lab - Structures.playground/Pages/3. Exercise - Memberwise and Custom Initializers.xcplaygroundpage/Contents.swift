...
var favoriteBook = Book(title: "The Martian", author: "Andy Weir", pages: 369, price: 10.41)
print("My favorite book is called \(favoriteBook.title) by \(favoriteBook.author). The book is \(favoriteBook.pages) pages and it costs \(favoriteBook.price) on amazon.")
/*:
...
print(Height.init(heightInInches: 65))
