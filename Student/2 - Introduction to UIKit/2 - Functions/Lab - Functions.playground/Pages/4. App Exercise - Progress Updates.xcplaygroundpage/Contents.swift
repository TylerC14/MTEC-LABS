...
func progressUpdate(steps: Int, goal: Int) {
    let steps: Double = 400
    let goal: Double = 9000
    if steps < goal * 0.10 {
...
pacing(currentDistance: 500, totalDistance: 1000, currentTime: 30, goalTime: 60)
/*:
