...
let runningWorkoutOne = RunningWorkout(distance: 25.10, time: 30.30)
let swimmingWorkoutOne = SwimmingWorkout(distance: 20.45, time: 25.35)
simpleWorkoutDescription(workout: runningWorkoutOne)
simpleWorkoutDescription(workout: swimmingWorkoutOne)
